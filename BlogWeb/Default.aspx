                ...
                <ItemTemplate>
                    <div class="my-auto">
                        ...
                        <div class="subheading mb-5">
                            ...
                            Mail:
                            <asp:Label ID="Label5" runat="server" Text='<%# Eval("MAIL") %>'></asp:Label><p></p>
                            Not:
                            <asp:Label ID="Label6" runat="server" Text='<%# Eval("KISANOT") %>'></asp:Label><p></p>
                        </div>
